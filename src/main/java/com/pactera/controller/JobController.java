...
import com.pactera.service.DynamicJobService;
import com.pactera.controller.param.ModifyCronDTO;
...
public class JobController {
    ...
    public String refresh(@PathVariable @NotNull Integer id) throws SchedulerException, ClassNotFoundException {
        String result;
        ...
        synchronized (log) {
            ...
            if (entity.getStatus().equals("OPEN")) {
                ...
                result = "Refresh Job : " + entity.getName() + "\t jobGroup: " + entity.getJobGroup() + " success !";
            } else {
                result = "Refresh Job : " + entity.getName() + "\t jobGroup: " + entity.getJobGroup() + " failed ! , " +
